...
rie um programa que ajude Ana a percorrer a lista de projetos e exiba os nomes dos projetos válidos.
...
for projeto in projetos:
    if projeto == None:
        print("Projeto ausente") #se existir um campo none, substitui por essa string
    else:
        print(projeto) #se nao, mostra a string da lista